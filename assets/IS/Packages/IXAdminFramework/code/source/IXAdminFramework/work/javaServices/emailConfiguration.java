...

{
	...
	final static emailConfiguration _instance = new emailConfiguration();

	static emailConfiguration _newInstance() { return new emailConfiguration(); }

	static emailConfiguration _cast(Object o) { return (emailConfiguration)o; }
