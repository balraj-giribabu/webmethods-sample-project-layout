...
@ManagedBean(name = "LicenseEligibiltyTaskView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "LicenseEligibiltyTaskView", beanType = BeanType.PORTLET)
public class LicenseEligibiltyTaskView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public LicenseEligibiltyTaskView() {
