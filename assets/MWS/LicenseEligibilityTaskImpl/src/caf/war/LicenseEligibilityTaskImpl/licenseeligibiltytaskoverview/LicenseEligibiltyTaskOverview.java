...
@ManagedBean(name = "LicenseEligibiltyTaskOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "LicenseEligibiltyTaskOverview", beanType = BeanType.PORTLET)
public class LicenseEligibiltyTaskOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {

	private transient caf.war.LicenseEligibilityTaskImpl.LicenseEligibilityTaskImpl licenseEligibilityTaskImpl = null;
	/**
	 ...
	 */
	public LicenseEligibiltyTaskOverview() {
	...
	public caf.war.LicenseEligibilityTaskImpl.LicenseEligibilityTaskImpl getLicenseEligibilityTaskImpl()  {
		if (licenseEligibilityTaskImpl == null) {
		    licenseEligibilityTaskImpl = (caf.war.LicenseEligibilityTaskImpl.LicenseEligibilityTaskImpl)resolveExpression("#{LicenseEligibilityTaskImpl}");
		}
		return licenseEligibilityTaskImpl;
	}
