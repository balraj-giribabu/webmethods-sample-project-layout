...
@ManagedBean(name = "IssueLicenceTaskView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "IssueLicenceTaskView", beanType = BeanType.PORTLET)
public class IssueLicenceTaskView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
