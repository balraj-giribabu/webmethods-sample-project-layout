...
@ManagedBean(name = "IssueLicenceTaskOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "IssueLicenceTaskOverview", beanType = BeanType.PORTLET)
public class IssueLicenceTaskOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public IssueLicenceTaskOverview() {
