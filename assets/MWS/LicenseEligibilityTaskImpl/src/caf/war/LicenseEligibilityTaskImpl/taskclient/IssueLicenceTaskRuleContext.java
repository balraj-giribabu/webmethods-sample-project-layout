...
import caf.war.LicenseEligibilityTaskImpl.taskclient.IssueLicenceTask.TaskData;
import caf.war.LicenseEligibilityTaskImpl.is.document.ADESPLicenseMgmt_documents_LicenceIssuanceProc_BusinessDoc;
import caf.war.LicenseEligibilityTaskImpl.is.document.ADESPLicenseMgmt_documents_LicenceIssuanceProc_TaskConfig;
...
@ManagedBean(name = "IssueLicenceTaskRuleContext")
@SessionScoped
@DTManagedBean(displayName = "IssueLicenceTask Rule Context", beanType = BeanType.DEFAULT)
public class IssueLicenceTaskRuleContext  extends  com.webmethods.caf.faces.data.task.impl.BaseTaskRuleContext {
...
public String onQueue() throws Exception{
	IssueLicenceTask currentTask = (IssueLicenceTask) this.getCurrentTask();
	caf.war.LicenseEligibilityTaskImpl.taskclient.IssueLicenceTask.TaskData taskData = currentTask
			.getTaskData();
	...
	ADESPLicenseMgmt_documents_LicenceIssuanceProc_BusinessDoc businessDoc = currentTask.getTaskData().getBusinessDoc();
		...
		//		System.out.println("inside parallel task" );
			...
			//		System.out.println("queuing child tasks" );
					...
					for (String assignee : taskConfig.getAssignee()) {
						IssueLicenceTask collaborationTask = new IssueLicenceTask();
