...
@ManagedBean(name = "ObjectionsTaskOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ObjectionsTaskOverview", beanType = BeanType.PORTLET)
public class ObjectionsTaskOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
