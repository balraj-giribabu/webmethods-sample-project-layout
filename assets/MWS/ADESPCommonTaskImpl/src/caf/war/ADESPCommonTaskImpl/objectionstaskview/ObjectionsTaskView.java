...
@ManagedBean(name = "ObjectionsTaskView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ObjectionsTaskView", beanType = BeanType.PORTLET)
public class ObjectionsTaskView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {

	private transient caf.war.ADESPCommonTaskImpl.Adespcommontaskimpl adespcommontaskimpl = null;
	/**
	...
	public caf.war.ADESPCommonTaskImpl.Adespcommontaskimpl getAdespcommontaskimpl()  {
		if (adespcommontaskimpl == null) {
		    adespcommontaskimpl = (caf.war.ADESPCommonTaskImpl.Adespcommontaskimpl)resolveExpression("#{Adespcommontaskimpl}");
		}
		return adespcommontaskimpl;
	}
