 ...
 * IS document wrapper
 */
public  class ADESPCommon_documents_publicRegistry_BusinessDoc extends java.lang.Object implements Serializable {

	
	private static final long serialVersionUID = 1L;
	// IS Document type used to generate this class
	public static final String DOCUMENT_TYPE = "ADESPCommon.documents.publicRegistry:BusinessDoc";
	...
	public static String[][] FIELD_NAMES = new String[][] {{"requestId", "requestId"},{"requestType", "requestType"},{"licenceType", "licenceType"},{"publicNoticeId", "publicNoticeId"},{"action", "action"},{"status", "status"},{"notificationId", "notificationId"},{"interfaceId", "interfaceId"},{"processId", "processId"},{"childCount", "childCount"},{"isChildTask", "isChildTask"},{"companyAssignees", "companyAssignees"},{"taskConfig", "taskConfig"},
	};
	private caf.war.ADESPCommonTaskImpl.is.document.IXCommon_documents_TaskConfig[] taskConfig = null;

	
	public ADESPCommon_documents_publicRegistry_BusinessDoc() {
	}
