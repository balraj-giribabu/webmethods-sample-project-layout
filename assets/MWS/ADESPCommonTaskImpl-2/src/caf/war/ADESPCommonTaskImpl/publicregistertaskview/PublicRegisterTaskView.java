...
@ManagedBean(name = "PublicRegisterTaskView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "PublicRegisterTaskView", beanType = BeanType.PORTLET)
public class PublicRegisterTaskView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
