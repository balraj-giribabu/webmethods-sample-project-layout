...
@ManagedBean(name = "PublicRegisterTaskOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "PublicRegisterTaskOverview", beanType = BeanType.PORTLET)
public class PublicRegisterTaskOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public PublicRegisterTaskOverview() {
