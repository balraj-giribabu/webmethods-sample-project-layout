...
@ManagedBean(name = "ComplianceTaskOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ComplianceTaskOverview", beanType = BeanType.PORTLET)
public class ComplianceTaskOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {

	private transient caf.war.ADESPComplianceTaskImpl.Adespcompliancetaskimpl adespcompliancetaskimpl = null;
	/**
	...
	public caf.war.ADESPComplianceTaskImpl.Adespcompliancetaskimpl getAdespcompliancetaskimpl()  {
		if (adespcompliancetaskimpl == null) {
		    adespcompliancetaskimpl = (caf.war.ADESPComplianceTaskImpl.Adespcompliancetaskimpl)resolveExpression("#{Adespcompliancetaskimpl}");
		}
		return adespcompliancetaskimpl;
	}
