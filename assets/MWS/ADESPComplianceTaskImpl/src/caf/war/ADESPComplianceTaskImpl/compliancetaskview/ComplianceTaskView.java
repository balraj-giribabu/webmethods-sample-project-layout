...
@ManagedBean(name = "ComplianceTaskView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "ComplianceTaskView", beanType = BeanType.PORTLET)
public class ComplianceTaskView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
