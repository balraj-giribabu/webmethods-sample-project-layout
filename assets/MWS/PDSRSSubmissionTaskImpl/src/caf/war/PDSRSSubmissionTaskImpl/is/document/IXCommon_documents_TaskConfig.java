...
public  class IXCommon_documents_TaskConfig extends java.lang.Object implements Serializable {
	...
	private caf.war.PDSRSSubmissionTaskImpl.is.document.IXCommon_documents_TaskConfig.Actions[] actions = null;
	...
	public caf.war.PDSRSSubmissionTaskImpl.is.document.IXCommon_documents_TaskConfig.Actions[] getActions()  {
		if (actions == null) {
			//TODO: create/set default value here
		}
		return actions;
	...
	public void setActions(caf.war.PDSRSSubmissionTaskImpl.is.document.IXCommon_documents_TaskConfig.Actions[] actions)  {
