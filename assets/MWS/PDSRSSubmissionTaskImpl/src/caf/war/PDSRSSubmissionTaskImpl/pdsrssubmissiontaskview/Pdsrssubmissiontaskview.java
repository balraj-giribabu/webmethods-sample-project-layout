...
@ManagedBean(name = "Pdsrssubmissiontaskview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "PDSRSSubmissionTaskView", beanType = BeanType.PORTLET)
public class Pdsrssubmissiontaskview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public Pdsrssubmissiontaskview() {
