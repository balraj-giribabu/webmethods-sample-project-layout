...
@ManagedBean(name = "Pdsrssubmissiontaskoverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "PDSRSSubmissionTaskOverview", beanType = BeanType.PORTLET)
public class Pdsrssubmissiontaskoverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {

	private transient caf.war.PDSRSSubmissionTaskImpl.Pdsrssubmissiontaskimpl pdsrssubmissiontaskimpl = null;
	/**
	 ...
	 */
	public Pdsrssubmissiontaskoverview() {
	...
	public caf.war.PDSRSSubmissionTaskImpl.Pdsrssubmissiontaskimpl getPdsrssubmissiontaskimpl()  {
		if (pdsrssubmissiontaskimpl == null) {
		    pdsrssubmissiontaskimpl = (caf.war.PDSRSSubmissionTaskImpl.Pdsrssubmissiontaskimpl)resolveExpression("#{Pdsrssubmissiontaskimpl}");
		}
		return pdsrssubmissiontaskimpl;
	}
